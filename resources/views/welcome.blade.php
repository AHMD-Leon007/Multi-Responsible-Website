...
<body id="home" class="homepage">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="{{ asset('frontend/images/main-feature.png') }}" alt="">
                </div>
                <div class="col-sm-6">
            ...
            <div class="portfolio-items">
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{ asset('frontend/images/portfolio/01.jpg') }}" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 1</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="{{ asset('frontend/images/portfolio/full.jpg') }}" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div>
                <!--/.portfolio-item-->
                ...
                <div class="portfolio-item corporate portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{ asset('frontend/images/portfolio/02.jpg') }}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{ asset('frontend/images/portfolio/03.jpg') }}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{ asset('frontend/images/portfolio/04.jpg') }}" alt="">
                        <div class="portfolio-info">
    ...
    <script src="{{ asset('frontend/js/mousescroll.js') }}"></script>
