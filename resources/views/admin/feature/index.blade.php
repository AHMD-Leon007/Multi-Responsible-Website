            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h2 class="card-title ">Feature Table
                    <a href="{{ route('feature.create') }}" class="btn btn-info float-right">Add New</a>
                  </h2>
                  ...
                  <div class="table-responsive">
                    <table id="table" class="table table-striped table-bordered">
                      <thead class=" text-primary">
                        ...
                        <th>Feature Logo</th>
                        <th>Feature Title</th>
                        <th style="width: 300px;">Feature Details</th>
                        <th>Created AT</th>
                        <th>Updated At</th>
                        <th>Action</th>
                      </thead>
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            	{{-- edit --}}
                            	<a href="{{ route('feature.edit', $feature->id) }}" class="btn btn-info btn-sm"><i class="material-icons">edit</i></a>
                            	{{-- delete --}}
