            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h2 class="card-title ">Slider Table
                    <a href="{{ route('slider.create') }}" class="btn btn-info float-right">Add New</a>
                  </h2>
                  ...
                  <div class="table-responsive">
                    <table id="table" class="table table-striped table-bordered">
                      <thead class=" text-primary">
                        ...
                        <th style="width: 250px;">Sub Title</th>
                        <th>Image</th>
                        <th>Created AT</th>
                        <th>Updated At</th>
                        <th>Action</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <img src="{{ asset('uploads/slider/'.$slider->image) }}" style="height: 100px; width: 150px;">
                            </td>
